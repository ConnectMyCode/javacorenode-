...
import com.object.oriented.programming.oop.blc.gabageCollector;

public class gabageCollectorMain {
	
	public static void main(String args[])
	{	
		System.out.print("gab1 pointing to --> 1000x , obj1 in heap is present ");
		gabageCollector gab1 = new gabageCollector(12.34f,69.9);
		System.out.println(gab1); 
		
		System.out.print("gab2 copies address from gab1: 1000x gab2 is pointing to same--> 1000x as gab1, obj1 in heap is present and pointed by 2 reference varaible.: gab1 , gab2");
