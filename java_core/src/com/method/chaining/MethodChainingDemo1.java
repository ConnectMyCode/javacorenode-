...
public class MethodChainingDemo1 {
	...
	public static void main(String []args) 
	{
		...
		String str = "India";
		char ch = str.concat("Is Growing").toUpperCase().charAt(0);  //-->Method Chaining
		System.out.println(ch);
		
		
		
		String str2 = "Java";
		int length = str2.concat("Making a Valid Statement.").toLowerCase().length();
		...
		case 'w'-> System.out.println("White Color");
		}
	}
}
