...
public class PaymentGatewayUsingInterfaceDemo1 {
	...
	public static void main(String []args){
		...
		PaymentGatewayDemo1 gate1 = new PaymentGatewayDemo1(paymentChoice);  //Entering the user choice of Payment Method  as String VAlue to Class object "PaymentGatewayDemo1".  
		...
		if(Paymentprocess instanceof UPIPaymentDemo1 upi) 
